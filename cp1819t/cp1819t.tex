...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{init}\mathrel{=}(\mathrm{1},\mathbin{-}(\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2},\mathrm{4},\mathrm{3}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
