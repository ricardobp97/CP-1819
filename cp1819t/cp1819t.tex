...
\\
\>[B]{}\Varid{show''}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{shownum}}{\Varid{g}}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{auxShow}\;\Varid{s}\mathrel{=}\Varid{substring}\;(\Varid{s},(\mathrm{1},(\length \;(\Varid{s})\mathbin{-}\mathrm{1}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g}\mathbin{::}(\Conid{Op},(\Conid{String},\Conid{String}))\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{g}\;(\Varid{op},(\Varid{s1},\Varid{s2})){}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mid \Varid{op}\equiv (\Conid{Op}\;\text{\tt \char34 +\char34})\mathrel{=}[\mskip1.5mu \text{\tt '('}\mskip1.5mu]\plus \Varid{s1}\plus [\mskip1.5mu \text{\tt '+'}\mskip1.5mu]\plus \Varid{s2}\plus [\mskip1.5mu \text{\tt ')'}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mid \Varid{op}\equiv (\Conid{Op}\;\text{\tt \char34 *\char34})\mathrel{=}[\mskip1.5mu \text{\tt '('}\mskip1.5mu]\plus \Varid{s1}\plus [\mskip1.5mu \text{\tt '*'}\mskip1.5mu]\plus \Varid{s2}\plus [\mskip1.5mu \text{\tt ')'}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment versão alternativa nenhuma versao funciona?????????}{}\<[E]%
\\
\>[B]{}\Varid{show'}\mathbin{::}\Conid{Expr}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{show'}\mathrel{=}\Varid{rempara}\comp \Varid{cataExpr}\;\alt{\Varid{g1}}{\Varid{g2}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g1}\mathbin{::}\Conid{Int}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{g1}\mathrel{=}\Varid{cond}\;(\mathrm{0}\leq )\;(\Varid{show})\;(\Varid{paravolta}\comp \Varid{show}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g2}\mathbin{::}(\Conid{Op},(\Conid{String},\Conid{String}))\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{g2}\;(\Varid{op},(\Varid{s1},\Varid{s2}))\mathrel{=}\mathbf{if}\;(\Varid{op}\equiv (\Conid{Op}\;\text{\tt \char34 +\char34}))\;\mathbf{then}\;\Varid{paravolta}\;(\Varid{s1}\plus [\mskip1.5mu \text{\tt '+'}\mskip1.5mu]\plus \Varid{s2}){}\<[E]%
\\
\>[B]{}\hsindent{37}{}\<[37]%
\>[37]{}\mathbf{else}\;\Varid{paravolta}\;(\Varid{s1}\plus [\mskip1.5mu \text{\tt '*'}\mskip1.5mu]\plus \Varid{s2}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{paravolta}\mathbin{::}\Conid{String}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{paravolta}\;\Varid{s}\mathrel{=}[\mskip1.5mu \text{\tt '('}\mskip1.5mu]\plus \Varid{s}\plus [\mskip1.5mu \text{\tt ')'}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rempara}\;\Varid{s}\mathrel{=}\mathbf{if}\;(\length \;(\Varid{s})\mathbin{>}\mathrm{4})\;\mathbf{then}\;\Varid{substring}\;(\Varid{s},(\mathrm{1},(\length \;(\Varid{s})\mathbin{-}\mathrm{1}))){}\<[E]%
\\
\>[B]{}\hsindent{29}{}\<[29]%
\>[29]{}\mathbf{else}\;\Varid{s}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{check}\mathrel{=}\Varid{cataFS}\;(\Varid{parbool}\comp \conj{\Varid{repetidos}\comp \map \;(\p1)}{\Varid{tof}\comp \map \;(\alt{\Varid{true}}{\Varid{id}}\comp \p2)}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{tof}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{tof}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}\mathbf{if}\;(\Varid{x}\equiv \Conid{False})\;\mathbf{then}\;\Conid{False}\;\mathbf{else}\;\Varid{tof}\;\Varid{xs}{}\<[E]%
\\[\blanklineskip]%
