...
\\
\>[B]{}\Varid{uncurriedBop}\mathbin{::}(\Conid{Op},(\Conid{Expr},\Conid{Expr}))\to \Conid{Expr}{}\<[E]%
\\
\>[B]{}\Varid{uncurriedBop}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\Conid{Bop}\;\Varid{b}\;\Varid{a}\;\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\Varid{calcula'}\mathbin{::}\Conid{Expr}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{calcula'}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{id}}{\Varid{cond}\;(((\Conid{Op}\;\text{\tt \char34 +\char34})\equiv )\comp \p1)\;(\Varid{fromIntegral}\comp \Varid{add}\comp (\Varid{toInteger}\times\Varid{toInteger})\comp \p2)\;(\Varid{fromIntegral}\comp \Varid{mul}\comp (\Varid{toInteger}\times\Varid{toInteger})\comp \p2)}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;(\Varid{p},\Varid{c})\mathrel{=}\Varid{auxCompile}\;\Varid{l}\;\mathrm{0}\;\mathrm{0}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxCompile}\mathbin{::}\Conid{String}\to \Conid{Int}\to \Conid{Int}\to (\Conid{Int},\Conid{Char}){}\<[E]%
\\
\>[B]{}\Varid{auxCompile}\;(\Varid{h}\mathbin{:}\Varid{t})\;\Varid{c}\;\Varid{p}{}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mid (\Varid{h}\equiv \text{\tt '('})\mathrel{=}\Varid{auxCompile}\;\Varid{t}\;(\Varid{c}\mathbin{+}\mathrm{1})\;(\Varid{p}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mid (\Varid{h}\equiv \text{\tt ')'})\mathrel{=}\Varid{auxCompile}\;\Varid{t}\;(\Varid{c}\mathbin{-}\mathrm{1})\;(\Varid{p}\mathbin{+}\mathrm{1}){}\<[E]%
\\
...
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mid \Varid{otherwise}\mathrel{=}\Varid{auxCompile}\;\Varid{t}\;\Varid{c}\;(\Varid{p}\mathbin{+}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
...
\>[14]{}\mathrel{=}\alt{\Varid{asda}}{\Varid{auxConq}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{asda}\mathbin{::}\Conid{Int}\to \Conid{Codigo}{}\<[E]%
\\
\>[B]{}\Varid{asda}\;\Varid{a}\mathrel{=}[\mskip1.5mu \text{\tt \char34 PUSH~\char34}\plus \Varid{show}\;(\Varid{a})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxConq}\;(\Varid{op},(\Varid{c1},\Varid{c2})){}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mid \Varid{op}\equiv (\Conid{Op}\;\text{\tt \char34 +\char34})\mathrel{=}\Varid{c1}\plus \Varid{c2}\plus [\mskip1.5mu \text{\tt \char34 ADD\char34}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mid \Varid{op}\equiv (\Conid{Op}\;\text{\tt \char34 *\char34})\mathrel{=}\Varid{c1}\plus \Varid{c2}\plus [\mskip1.5mu \text{\tt \char34 MUL\char34}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
