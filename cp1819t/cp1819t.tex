...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Int}\mathbin{+}(\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr}))}
           \ar[d]_-{\ensuremath{[\mskip1.5mu \Varid{f},\Varid{g}\mskip1.5mu]}}
\\
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr})}
           \ar[d]_-{\ensuremath{\Varid{assocl}}}
\\
    \ensuremath{(\Conid{Op}\times\Conid{Expr})\times\Conid{Expr}}
           \ar[d]_-{\ensuremath{\Varid{swap}\times\Varid{id}}}
\\
    \ensuremath{(\Conid{Expr}\times\Conid{Op})\times\Conid{Expr}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr})}
           \ar[d]_-{\ensuremath{((\uncurry{\cdot }\comp \uncurry{\cdot })\;\Conid{Bop})\comp ((\Varid{swap}\times\Varid{id})\comp \Varid{assocl})}}
\\
     \ensuremath{\Conid{Expr}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{inExpr}\mathrel{=}\alt{\Conid{Num}}{((\uncurry{\cdot }\comp \uncurry{\cdot })\;\Conid{Bop})\comp ((\Varid{swap}\times\Varid{id})\comp \Varid{assocl})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
     \ensuremath{\Conid{Int}\mathbin{+}(\Conid{Op}\times(\Conid{Int}\times\Conid{Int}))}
           \ar[l]^-{\ensuremath{[\mskip1.5mu \Varid{id},\Varid{calcop}\mskip1.5mu]}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{calcula}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{id}}{\Varid{calcop}}{}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mathbf{where}\;\Varid{calcop}\;(\Conid{Op}\;\text{\tt \char34 +\char34},(e_1 ,e_2 ))\mathrel{=}e_1 \mathbin{+}e_2 {}\<[E]%
\\
\>[15]{}\hsindent{6}{}\<[21]%
\>[21]{}\Varid{calcop}\;(\Conid{Op}\;\text{\tt \char34 *\char34},(e_1 ,e_2 ))\mathrel{=}e_1 \mathbin{*}e_2 {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  versao alternativa pointfree}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcula'}\mathbin{::}\Conid{Expr}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{calcula'}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{id}}{\Varid{cond}\;(((\Conid{Op}\;\text{\tt \char34 +\char34})\equiv )\comp \p1)\;{}\<[E]%
\\
\>[B]{}\hsindent{35}{}\<[35]%
\>[35]{}(\Varid{fromIntegral}\comp \Varid{add}\comp (\Varid{toInteger}\times\Varid{toInteger})\comp \p2)\;{}\<[E]%
\\
\>[B]{}\hsindent{35}{}\<[35]%
\>[35]{}(\Varid{fromIntegral}\comp \Varid{mul}\comp (\Varid{toInteger}\times\Varid{toInteger})\comp \p2)}{}\<[E]%
\\[\blanklineskip]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{compile}\mathrel{=}\Varid{hyloExpr}\;\Varid{conqCompile}\;\Varid{divCompile}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment versao alternativa pointfree}{}\<[E]%
\\
\>[B]{}\Varid{compile'}\mathbin{::}\Conid{String}\to \Conid{Codigo}{}\<[E]%
...
\column{35}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{divCompile}\mathbin{::}\Conid{String}\to \Conid{Int}+(\Conid{Op},(\Conid{String},\Conid{String})){}\<[E]%
\\
\>[B]{}\Varid{divCompile}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}i_1\;(\Varid{digitToInt}\;(\Varid{x})){}\<[E]%
\\
\>[B]{}\Varid{divCompile}\;\Varid{l}\mathrel{=}i_2\;((\Conid{Op}\;[\mskip1.5mu \Varid{c}\mskip1.5mu]),(\Varid{slice}\;\mathrm{0}\;\Varid{p}\;\Varid{l},\Varid{slice}\;(\Varid{p}\mathbin{+}\mathrm{1})\;(\length \;(\Varid{l}))\;\Varid{l})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;(\Varid{p},\Varid{c})\mathrel{=}\Varid{auxDivComp}\;\Varid{l}\;\mathrm{0}\;\mathrm{0}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxDivComp}\mathbin{::}\Conid{String}\to \Conid{Int}\to \Conid{Int}\to (\Conid{Int},\Conid{Char}){}\<[E]%
\\
\>[B]{}\Varid{auxDivComp}\;(\Varid{h}\mathbin{:}\Varid{t})\;\Varid{c}\;\Varid{p}{}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mid (\Varid{h}\equiv \text{\tt '('})\mathrel{=}\Varid{auxDivComp}\;\Varid{t}\;(\Varid{c}\mathbin{+}\mathrm{1})\;(\Varid{p}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mid (\Varid{h}\equiv \text{\tt ')'})\mathrel{=}\Varid{auxDivComp}\;\Varid{t}\;(\Varid{c}\mathbin{-}\mathrm{1})\;(\Varid{p}\mathbin{+}\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mid (\Varid{h}\equiv \text{\tt '+'}\mathrel{\vee}\Varid{h}\equiv \text{\tt '*'})\mathrel{\wedge}\Varid{c}\equiv \mathrm{0}\mathrel{=}(\Varid{p},\Varid{h}){}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mid \Varid{otherwise}\mathrel{=}\Varid{auxDivComp}\;\Varid{t}\;\Varid{c}\;(\Varid{p}\mathbin{+}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{slice}\mathbin{::}\Conid{Int}\to \Conid{Int}\to \Conid{String}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{slice}\;\Varid{start}\;\Varid{end}\;\Varid{string}\mathrel{=}\mathbf{if}\;(\Varid{head}\;(\Varid{firstslice})\equiv \text{\tt '('})\;\mathbf{then}\;(\Varid{slice}\;(\Varid{start}\mathbin{+}\mathrm{1})\;(\Varid{end}\mathbin{-}\mathrm{1})\;\Varid{string})\;\mathbf{else}\;\Varid{firstslice}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{firstslice}\mathrel{=}\Varid{take}\;(\Varid{end}\mathbin{-}\Varid{start})\;(\Varid{drop}\;\Varid{start}\;\Varid{string}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  versao alternativa pointfree divcompile e slice}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{divCompile'}\mathbin{::}\Conid{String}\to \Conid{Int}+(\Conid{Op},(\Conid{String},\Conid{String})){}\<[E]%
\\
\>[B]{}\Varid{divCompile'}\;[\mskip1.5mu \Varid{x}\mskip1.5mu]\mathrel{=}i_1\;(\Varid{digitToInt}\;(\Varid{x})){}\<[E]%
\\
\>[B]{}\Varid{divCompile'}\;\Varid{l}\mathrel{=}i_2\;((\Conid{Op}\;[\mskip1.5mu \Varid{c}\mskip1.5mu]),({}\<[35]%
\>[35]{}\Varid{slice'}\;(\Varid{l},(\mathrm{0},\Varid{p})),\Varid{slice'}\;(\Varid{l},((\Varid{p}\mathbin{+}\mathrm{1}),(\length \;(\Varid{l})))))){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;(\Varid{p},\Varid{c})\mathrel{=}\Varid{auxDivComp}\;\Varid{l}\;\mathrm{0}\;\mathrm{0}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{substring}\mathbin{::}(\Conid{String},(\Conid{Int},\Conid{Int}))\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{substring}\mathrel{=}(\uncurry{\Varid{take}}\comp \Varid{swap}\comp (\Varid{id}\times\uncurry{\Varid{subtract}}))\comp \conj{\uncurry{\Varid{drop}}\comp \Varid{swap}\comp (\Varid{id}\times\p1)}{\p2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{slice'}\mathbin{::}(\Conid{String},(\Conid{Int},\Conid{Int}))\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{slice'}\mathrel{=}(\Varid{cond}\;((\text{\tt '('}\equiv )\comp \Varid{head}\comp \p1)\;(\Varid{slice'}\comp (\Varid{id}\times(\succ \times\Varid{pred}))\comp \p2)\;\p1)\comp \conj{\Varid{substring}}{\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{conqCompile}\mathbin{::}\Conid{Int}+(\Conid{Op},(\Conid{Codigo},\Conid{Codigo}))\to \Conid{Codigo}{}\<[E]%
\\
\>[B]{}\Varid{conqCompile}{}\<[14]%
\>[14]{}\mathrel{=}\alt{\Varid{auxNum}}{\Varid{auxOp}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxNum}\mathbin{::}\Conid{Int}\to \Conid{Codigo}{}\<[E]%
\\
\>[B]{}\Varid{auxNum}\;\Varid{a}\mathrel{=}[\mskip1.5mu \text{\tt \char34 PUSH~\char34}\plus \Varid{show}\;(\Varid{a})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxOp}\;(\Varid{op},(\Varid{c1},\Varid{c2})){}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mid \Varid{op}\equiv (\Conid{Op}\;\text{\tt \char34 +\char34})\mathrel{=}\Varid{c1}\plus \Varid{c2}\plus [\mskip1.5mu \text{\tt \char34 ADD\char34}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mid \Varid{op}\equiv (\Conid{Op}\;\text{\tt \char34 *\char34})\mathrel{=}\Varid{c1}\plus \Varid{c2}\plus [\mskip1.5mu \text{\tt \char34 MUL\char34}\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment  versao alternativa pointfree conqcompile e auxiliares}{}\<[E]%
\\
\>[B]{}\Varid{conqCompile'}\mathrel{=}\alt{\Varid{singl}\comp \mathsf{conc}\comp \conj{\underline{\text{\tt \char34 PUSH~\char34}}}{\Varid{show}}}{\Varid{cond}\;(((\Conid{Op}\;\text{\tt \char34 +\char34})\equiv )\comp \p1)\;(\mathsf{conc}\comp \Varid{swap}\comp (\underline{[\mskip1.5mu \text{\tt \char34 ADD\char34}\mskip1.5mu]}\times\mathsf{conc}))\;(\mathsf{conc}\comp \Varid{swap}\comp (\underline{[\mskip1.5mu \text{\tt \char34 MUL\char34}\mskip1.5mu]}\times\mathsf{conc}))}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
     \ensuremath{\Conid{Int}\mathbin{+}(\Conid{Op}\times(\Conid{String}\times\Conid{String}))}
           \ar[l]^-{\ensuremath{[\mskip1.5mu \Varid{shownum},\Varid{showop}\mskip1.5mu]}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{show'}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{showNum}}{\Varid{showOp}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{showNum}\;\Varid{a}\mathrel{=}\mathbf{if}\;(\Varid{a}\mathbin{<}\mathrm{0})\;\mathbf{then}\;[\mskip1.5mu \text{\tt '('}\mskip1.5mu]\plus (\Varid{show}\;\Varid{a})\plus [\mskip1.5mu \text{\tt ')'}\mskip1.5mu]\;\mathbf{else}\;(\Varid{show}\;\Varid{a}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{showOp}\mathbin{::}(\Conid{Op},(\Conid{String},\Conid{String}))\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{showOp}\;(\Varid{op},(\Varid{s1},\Varid{s2})){}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{op}\equiv (\Conid{Op}\;\text{\tt \char34 +\char34})\mathrel{=}[\mskip1.5mu \text{\tt '('}\mskip1.5mu]\plus \Varid{s1}\plus [\mskip1.5mu \text{\tt '+'}\mskip1.5mu]\plus \Varid{s2}\plus [\mskip1.5mu \text{\tt ')'}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mid \Varid{otherwise}\mathrel{=}[\mskip1.5mu \text{\tt '('}\mskip1.5mu]\plus \Varid{s1}\plus [\mskip1.5mu \text{\tt '*'}\mskip1.5mu]\plus \Varid{s2}\plus [\mskip1.5mu \text{\tt ')'}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inL2D}\mathrel{=}\alt{\Conid{Unid}}{\uncurry{(\uncurry{\cdot }\comp \Conid{Comp})}}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{outL2D}\;(\Conid{Comp}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}i_2\;(\Varid{a},(\Varid{b},\Varid{c})){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{hyloL2D}\;\Varid{h}\;\Varid{g}\mathrel{=}\Varid{cataL2D}\;\Varid{h}\comp \Varid{anaL2D}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{collectLeafs}\mathrel{=}\Varid{cataL2D}\;\alt{\Varid{singl}}{\mathsf{conc}\comp \p2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin --------------------?????--------------------- \commentend}{}\<[E]%
\\[\blanklineskip]%
...
Se $\ensuremath{\Varid{h}\;\Varid{x}\;\Varid{n}} = \frac{(-1)^{(n+1)}}{(2(n+1))!} * x^{2(n+1)}$, obtemos então:
\begin{eqnarray*}
  h\ x\ 0 = - \frac{x^2} {2}
\end{eqnarray*}
\begin{eqnarray*}
...
Desenvolvendo $\ensuremath{\Varid{h}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})}$:
\begin{eqnarray*}
...
Definindo as funções auxiliares a e b, que correspondem a $\ensuremath{\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{3}}$ e $\ensuremath{\mathrm{2}\;\Varid{n}\mathbin{+}\mathrm{4}}$ respetivamente, obtemos no final:
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cos}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{cos}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{cos}\;\Varid{x}\;\Varid{n}\mathbin{+}\Varid{h}\;\Varid{x}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{h}\;\Varid{x}\;\mathrm{0}\mathrel{=}((\mathbin{-}\Varid{x})\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{h}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\Varid{h}\;\Varid{x}\;\Varid{n}\mathbin{*}((\mathbin{-}\Varid{x})\mathbin{\uparrow}\mathrm{2})\mathbin{/}((\Varid{a}\;\Varid{n})\mathbin{*}(\Varid{b}\;\Varid{n})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{a}\;\mathrm{0}\mathrel{=}\mathrm{3}{}\<[E]%
\\
\>[B]{}\Varid{a}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{2}\mathbin{+}\Varid{a}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{b}\;\mathrm{0}\mathrel{=}\mathrm{4}{}\<[E]%
\\
\>[B]{}\Varid{b}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{2}\mathbin{+}\Varid{b}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{coss}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{coss}\;\Varid{x}\;\Varid{n})\mathbin{+}(\Varid{h}\;\Varid{x}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{h}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathbin{-}(\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{h}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{h}\;\Varid{x}\;\Varid{n})\mathbin{*}(\mathbin{-}(\Varid{x}\mathbin{\uparrow}\mathrm{2}))\mathbin{/}((\Varid{a}\;\Varid{n})\mathbin{*}(\Varid{b}\;\Varid{n})){}\<[E]%
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{loop}\;(\Varid{coss},\Varid{h},\Varid{a},\Varid{b})\mathrel{=}(\Varid{coss}\mathbin{+}\Varid{h},\Varid{h}\mathbin{*}(\mathbin{-}(\Varid{x}\mathbin{\uparrow}\mathrm{2}))\mathbin{/}(\Varid{a}\mathbin{*}\Varid{b}),\mathrm{2}\mathbin{+}\Varid{a},\mathrm{2}\mathbin{+}\Varid{b}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{init}\mathrel{=}(\mathrm{1},\mathbin{-}(\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2},\mathrm{3},\mathrm{4}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{prj}\;(\Varid{coss},\Varid{h},\Varid{a},\Varid{b})\mathrel{=}\Varid{coss}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\begin{tabbing}\tt
~double~coss\char40{}double~x\char44{}int~n\char41{}\char123{}\\
\tt ~~~\\
\tt ~~~double~res~\char61{}~1\char59{}\\
\tt ~~~double~h~\char61{}~\char45{}\char40{}x\char42{}x\char41{}\char47{}2\char59{}\\
\tt ~~~double~a~\char61{}~3\char59{}\\
\tt ~~~double~b~\char61{}~4\char59{}\\
\tt ~\\
\tt ~~~for~\char40{}int~i~\char61{}~1\char59{}~i~\char60{}\char61{}~n\char59{}~i\char43{}\char43{}\char41{}\char123{}~\\
\tt ~~~~~\\
\tt ~~~~~res~\char61{}~res~\char43{}~h\char59{}\\
\tt ~~~~~h~\char61{}~h~\char42{}\char40{}\char40{}\char45{}\char40{}x\char42{}x\char41{}\char41{}\char47{}\char40{}a\char42{}b\char41{}\char41{}\char59{}\\
\tt ~~~~~a~\char61{}~a~\char43{}~2\char59{}\\
\tt ~~~~~b~\char61{}~b~\char43{}~2\char59{}\\
\tt ~~~\char125{}\\
\tt ~\\
\tt ~~~return~res\char59{}\\
\tt ~\char125{}\\
\tt ~\\
\tt ~int~main\char40{}int~argc\char44{}~char~const~\char42{}argv\char91{}\char93{}\char41{}\char123{}\\
\tt ~~~if\char40{}argc~\char33{}\char61{}~3\char41{}\\
\tt ~~~~~return~0\char59{}\\
\tt ~\\
\tt ~~~double~r~\char61{}~coss\char40{}atof\char40{}argv\char91{}1\char93{}\char41{}\char44{}atoi\char40{}argv\char91{}2\char93{}\char41{}\char41{}\char59{}\\
\tt ~~~printf\char40{}\char34{}\char37{}\char46{}16f\char92{}n\char34{}\char44{}r\char41{}\char59{}\\
\tt ~~~\\
\tt ~~~return~0\char59{}\\
\tt ~\char125{}
\end{tabbing}
...
\\[\blanklineskip]%
\>[B]{}\Varid{outNode}\;(\Conid{File}\;\Varid{f})\mathrel{=}(i_1\;\Varid{f}){}\<[E]%
\\
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{FS}\;\Varid{a}\;\Varid{b}}
           \ar[d]_-{\ensuremath{\Varid{cataFS}\;\Varid{g}}}
&
    \ensuremath{(\Varid{a}\times(\Varid{b}\mathbin{+}\Conid{FS}\;\Varid{a}\;\Varid{b}))\mathbin{*}}
           \ar[d]^{\ensuremath{\map \;(\Varid{id}\times(\Varid{id}\mathbin{+}(\Varid{cataFS}\;\Varid{g}))\mathbin{*}}}
...
\\
\>[B]{}\Varid{check}\mathrel{=}\Varid{cataFS}\;(\Varid{parbool}\comp \conj{\Varid{repetidos}\comp \map \;(\p1)}{\Varid{check'}\comp \map \;(\alt{\Varid{true}}{\Varid{id}}\comp \p2)}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{parbool}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{if}\;(\Varid{a}\equiv \Conid{False}\mathrel{\vee}\Varid{b}\equiv \Conid{False})\;\mathbf{then}\;\Conid{False}\;\mathbf{else}\;\Conid{True}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{check'}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{check'}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}\mathbf{if}\;(\Varid{x}\equiv \Conid{False})\;\mathbf{then}\;\Conid{False}\;\mathbf{else}\;\Varid{check'}\;\Varid{xs}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{repetidos}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{repetidos}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\mathbf{if}\;(\Varid{x}\;\Varid{h}\;\Varid{t})\;\mathbf{then}\;\Conid{False}\;\mathbf{else}\;\Varid{repetidos}\;\Varid{t}{}\<[E]%
\\
\>[B]{}\hsindent{17}{}\<[17]%
\>[17]{}\mathbf{where}{}\<[E]%
\\
\>[17]{}\hsindent{2}{}\<[19]%
\>[19]{}\Varid{x}\;\Varid{h}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}\Conid{False}{}\<[E]%
\\
\>[17]{}\hsindent{2}{}\<[19]%
\>[19]{}\Varid{x}\;\Varid{h}\;(\Varid{y}\mathbin{:}\Varid{ys})\mathrel{=}\mathbf{if}\;(\Varid{h}\equiv \Varid{y})\;\mathbf{then}\;\Conid{True}\;\mathbf{else}\;\Varid{x}\;\Varid{h}\;\Varid{ys}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{FS}\;\Varid{a}\;\Varid{b}}
           \ar[d]_-{\ensuremath{\Varid{check}}}
&
    \ensuremath{(\Varid{a}\times(\Varid{b}\mathbin{+}\Conid{FS}\;\Varid{a}\;\Varid{b}))\mathbin{*}}
           \ar[d]^{\ensuremath{\map \;(\Varid{id}\times(\Varid{id}\mathbin{+}\Varid{check})\mathbin{*}}}
           \ar[l]_-{\ensuremath{\Varid{inFS}}}
\\
     \ensuremath{\Conid{Bool}}
&
     \ensuremath{(\Varid{a}\times(\Varid{b}\mathbin{+}\Conid{Bool}))\mathbin{*}}
...
\xymatrix@C=2cm{
    \ensuremath{(\Varid{a}\times(\Varid{b}\mathbin{+}\Conid{Bool}))\mathbin{*}}
           \ar[d]_-{\ensuremath{\mathbin{<}\Varid{repetidos}\comp \map \;(\p1),\Varid{check'}\comp (\map \;([\mskip1.5mu \Varid{true},\Varid{id}\mskip1.5mu]\comp \p2))\mathbin{>}}}
\\
    \ensuremath{\Conid{Bool}\times\Conid{Bool}}
           \ar[d]_-{\ensuremath{\Varid{parbool}}}
\\
    \ensuremath{\Conid{Bool}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{tar}\mathrel{=}\Varid{cataFS}\;(\Varid{disc}\comp \map \;(\Varid{auxtar})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{auxtar}\;(\Varid{a},(i_1\;\Varid{b}))\mathrel{=}[\mskip1.5mu ([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxtar}\;(\Varid{a},(i_2\;[\mskip1.5mu \mskip1.5mu]))\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{auxtar}\;(\Varid{a},(i_2\;((\Varid{x},\Varid{y})\mathbin{:}\Varid{xs})))\mathrel{=}([\mskip1.5mu \Varid{a}\mskip1.5mu]\plus \Varid{x},\Varid{y})\mathbin{:}\Varid{auxtar}\;(\Varid{a},i_2\;\Varid{xs}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{disc}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{disc}\;(\Varid{x}\mathbin{:}\Varid{xs})\mathrel{=}\Varid{x}\plus \Varid{disc}\;\Varid{xs}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{(\Varid{a}\times(\Varid{b}\mathbin{+}\Conid{FS}\;\Varid{a}\;\Varid{b}))\mathbin{*}}
           \ar[d]^{\ensuremath{\map \;(\Varid{id}\times(\Varid{id}\mathbin{+}\Varid{tar})\mathbin{*}}}
           \ar[l]_-{\ensuremath{\Varid{inFS}}}
\\
     \ensuremath{(\Conid{Path}\;\Varid{a}\times\Varid{b})\mathbin{*}}
&
     \ensuremath{(\Varid{a}\times(\Varid{b}\mathbin{+}(\Conid{Path}\;\Varid{a}\times\Varid{b})\mathbin{*}))\mathbin{*}}
           \ar[l]^-{\ensuremath{\Varid{disc}\comp \map \;(\Varid{auxtar})}}
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{untar}\mathrel{=}\Varid{joinDupDirs}\comp \Varid{anaFS}\;(\map \;(\Varid{intar})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{intar}\;([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{b})\mathrel{=}(\Varid{a},i_1\;\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{intar}\;((\Varid{x}\mathbin{:}\Varid{xs}),\Varid{b})\mathrel{=}(\Varid{x},i_2\;[\mskip1.5mu (\Varid{xs},\Varid{b})\mskip1.5mu]){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{(\Varid{a}\times(\Varid{b}\mathbin{+}(\Conid{Path}\;\Varid{a}\times\Varid{b})\mathbin{*}))\mathbin{*}}
           \ar[d]_-{\ensuremath{\map \;(\Varid{id}\times(\Varid{id}\mathbin{+}\Varid{untar})\mathbin{*}}}
&
    \ensuremath{(\Conid{Path}\;\Varid{a}\times\Varid{b})\mathbin{*}}
           \ar[d]^{\ensuremath{\Varid{untar}}}
           \ar[l]_-{\ensuremath{\map \;(\Varid{intar})}}
\\
     \ensuremath{(\Varid{a}\times(\Varid{b}\mathbin{+}\Conid{FS}\;\Varid{a}\;\Varid{b}))\mathbin{*}}
&
     \ensuremath{\Conid{FS}\;\Varid{a}\;\Varid{b}}
           \ar[l]^-{\ensuremath{\Varid{outFS}}}
}
\end{eqnarray*}
d)
\begin{hscode}\SaveRestoreHook
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\commentbegin ---------------- feito --------------------- \commentend}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{find}\mathrel{=}\Varid{curry}\;(\Varid{teste1}\comp (\Varid{id}\times\Varid{tar})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{teste1}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow (\Varid{a},[\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu])\to [\mskip1.5mu \Conid{Path}\;\Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{teste1}\;(\Varid{a},[\mskip1.5mu \mskip1.5mu])\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{teste1}\;(\Varid{a},(\Varid{l},\anonymous )\mathbin{:}\Varid{xs})\mathrel{=}\mathbf{if}\;(\Varid{last}\;(\Varid{l})\equiv \Varid{a})\;\mathbf{then}\;\Varid{l}\mathbin{:}\Varid{teste1}\;(\Varid{a},\Varid{xs})\;\mathbf{else}\;\Varid{teste1}\;(\Varid{a},\Varid{xs}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin --------------feito -------------------------- \commentend}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{new}\mathrel{=}\Varid{uncurriedNew}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{uncurriedNew}\;\Varid{p}\;\Varid{b}\;\Varid{fs}\mathrel{=}\Varid{untar}\;([\mskip1.5mu (\Varid{p},\Varid{b})\mskip1.5mu]\plus \Varid{tar}\;(\Varid{fs})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin ----feito------------------------------ \commentend}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cp}\mathrel{=}\Varid{cpaux}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cpaux}\;\Varid{s}\;\Varid{d}\;\Varid{f}\mathrel{=}\mathbf{if}\;(\Varid{s}\equiv [\mskip1.5mu \mskip1.5mu]\mathrel{\vee}\Varid{d}\equiv [\mskip1.5mu \mskip1.5mu])\;\mathbf{then}\;\Varid{f}\;\mathbf{else}\;\Varid{untar}\;([\mskip1.5mu (\Varid{d},\Varid{conteudo})\mskip1.5mu]\plus \Varid{ltar}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}{}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}\Varid{ltar}\mathrel{=}\Varid{tar}\;(\Varid{f}){}\<[E]%
\\
\>[11]{}\hsindent{2}{}\<[13]%
\>[13]{}\Varid{conteudo}\mathrel{=}\Varid{getconteudo}\;\Varid{s}\;\Varid{ltar}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{getconteudo}\mathbin{::}(\Conid{Eq}\;\Varid{a})\Rightarrow \Conid{Path}\;\Varid{a}\to [\mskip1.5mu (\Conid{Path}\;\Varid{a},\Varid{b})\mskip1.5mu]\to \Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{getconteudo}\;\Varid{d}\;[\mskip1.5mu (\Varid{l},\Varid{b})\mskip1.5mu]\mathrel{=}\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{getconteudo}\;\Varid{d}\;((\Varid{l},\Varid{b})\mathbin{:}\Varid{xs})\mathrel{=}\mathbf{if}\;(\Varid{l}\equiv \Varid{d})\;\mathbf{then}\;\Varid{b}\;\mathbf{else}\;(\Varid{getconteudo}\;\Varid{d}\;\Varid{xs}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin ----faltam fazer------------------------------ \commentend}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cFS2Exp}\mathrel{=}\Varid{curry}\;(\Varid{rootTerm}\comp (\Varid{id}\times\map \;(\Varid{anaExp}\;(\Varid{inTerm}))\comp \Varid{noFS})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{noFS}\;(\Conid{FS}\;\Varid{l})\mathrel{=}\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inTerm}\mathbin{::}(\Varid{a},\Conid{Node}\;\Varid{a}\;\Varid{b})\to ()+(\Varid{a},[\mskip1.5mu (\Varid{a},\Conid{Node}\;\Varid{a}\;\Varid{b})\mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{inTerm}\;(\Varid{a},\Conid{File}\;\Varid{b})\mathrel{=}i_2\;(\Varid{a},[\mskip1.5mu \mskip1.5mu]){}\<[E]%
\\
\>[B]{}\Varid{inTerm}\;(\Varid{a},\Conid{Dir}\;(\Conid{FS}\;\Varid{c}))\mathrel{=}i_2\;(\Varid{a},\Varid{c}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rootTerm}\;(\Varid{a},\Varid{b})\mathrel{=}\Conid{Term}\;\Varid{a}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
