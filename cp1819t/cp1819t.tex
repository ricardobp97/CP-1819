...
\\
\>[B]{}\Varid{inExpr}\mathrel{=}\alt{\Conid{Num}}{\Varid{uncurriedBop}}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{outExpr}\;(\Conid{Bop}\;\Varid{b}\;\Varid{a}\;\Varid{c})\mathrel{=}i_2\;(\Varid{a},(\Varid{b},\Varid{c})){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{hyloBTree}\;\Varid{h}\;\Varid{g}\mathrel{=}\Varid{cataExpr}\;\Varid{h}\comp \Varid{anaExpr}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcula}\mathbin{::}\Conid{Expr}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{calcula}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
